  ...
  return (
    <footer className="bg-background border-t">
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Campus Cart is a platform for students to buy and sell items easily within their campus community.
            </p>
          </div>
          <div>
        ...
        <div className="mt-8 border-t border-border pt-8 text-sm text-center text-muted-foreground">
